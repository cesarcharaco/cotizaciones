      ...
      <form action="#" method="POST" data-parsley-validate  name="cargaItemsForm" id="cargaItemsForm">
        <div class="modal-body">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12">
                <table id="totales" class="table table-bordered table-striped table-sm table-responsive" style="width: 100% !important">
                  <thead>
                    <tr>
                      <th style="width: 16% !important;">Precio Pesos SIN/IVA</th>
                      <th style="width: 16% !important;">UTI x Unidad</th>
                      <th style="width: 16% !important;">UTI x Total</th>
                      <th style="width: 19% !important;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                      <th style="width: 16% !important;">Precio Unit.</th>
                      <th style="width: 16% !important;">Total</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td align="center"><span id="total_pp_txt"></span><input type="hidden" name="total_pp" id="total_pp" >
                        <span id="pp_ci_txt" style="display: none;"></span><input type="hidden" name="pp_ci" id="pp_ci" ></td>
                      <!-- <td align="center"></td> -->
                    </tr>
                  </tbody>
                </table>
